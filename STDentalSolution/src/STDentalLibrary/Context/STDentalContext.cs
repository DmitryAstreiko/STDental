...
namespace STDentalLibrary.Context
{
    public class STDentalContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Server = tcp:stdentalreactdbserver.database.windows.net,1433; Initial Catalog = STDental_db; Persist Security Info = False; User ID = dentaladmin; Password = Preved_1Medved; MultipleActiveResultSets = False; Encrypt = True; TrustServerCertificate = False; Connection Timeout = 30");
